...
cfg["sft_factor"]     = 0.09
cfg["lorentz_dim"]    = 127
cfg["attention_num"]  = 8    # total attention branches (Euclidean + Hyperbolic)
...
cfg["curv_init"]      = 1.0
cfg["learn_curv"]     = True
cfg["use_hyperbolic"] = True   # set False to disable PoP entailment loss only; HLFormerBlock Lorentz branches are always active
...
cfg["loss_pop_coef"]      = 1e-3   # weight for hyperbolic entailment loss
cfg["hyp_saliency_coef"]  = 0.5    # weight for hyperbolic saliency ranking loss
